defmodule StellarBase.XDR.UpgradeTypeList6 do
  @moduledoc """
  ...
  Representation of Stellar `UpgradeTypeList6` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.UpgradeType

  @max_length 6

  @array_type UpgradeType

  @array_spec %{type: @array_type, max_length: @max_length}

  @type t :: %__MODULE__{items: list(UpgradeType.t())}

  defstruct [:items]

  @spec new(items :: list(UpgradeType.t())) :: t()
