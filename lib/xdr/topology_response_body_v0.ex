defmodule StellarBase.XDR.TopologyResponseBodyV0 do
  @moduledoc """
  ...
  Representation of Stellar `TopologyResponseBodyV0` type.
  """
  ...
  @type t :: %__MODULE__{inbound_peers: type_inbound_peers(), outbound_peers: type_outbound_peers(), total_inbound_peer_count: type_total_inbound_peer_count(), total_outbound_peer_count: type_total_outbound_peer_count()}

  defstruct [:inbound_peers, :outbound_peers, :total_inbound_peer_count, :total_outbound_peer_count]

  @spec new(inbound_peers :: type_inbound_peers(), outbound_peers :: type_outbound_peers(), total_inbound_peer_count :: type_total_inbound_peer_count(), total_outbound_peer_count :: type_total_outbound_peer_count()) :: t()
  def new(
