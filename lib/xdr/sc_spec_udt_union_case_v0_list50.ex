defmodule StellarBase.XDR.SCSpecUDTUnionCaseV0List50 do
  @moduledoc """
  ...
  Representation of Stellar `SCSpecUDTUnionCaseV0List50` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SCSpecUDTUnionCaseV0.t())}

  defstruct [:items]

  @spec new(items :: list(SCSpecUDTUnionCaseV0.t())) :: t()
