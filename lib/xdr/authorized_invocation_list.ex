defmodule StellarBase.XDR.AuthorizedInvocationList do
  ...
  Representation of Stellar `AuthorizedInvocationList` type.
  """
  ...
  @type t :: %__MODULE__{items: list(AuthorizedInvocation.t())}

  defstruct [:items]

  @spec new(items :: list(AuthorizedInvocation.t())) :: t()
