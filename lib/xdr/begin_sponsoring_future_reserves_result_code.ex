defmodule StellarBase.XDR.BeginSponsoringFutureReservesResultCode do
  @moduledoc """
  ...
  def new(type \\ :BEGIN_SPONSORING_FUTURE_RESERVES_SUCCESS), do: %__MODULE__{identifier: type}
