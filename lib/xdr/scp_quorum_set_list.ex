defmodule StellarBase.XDR.SCPQuorumSetList do
  @moduledoc """
  ...
  Representation of Stellar `SCPQuorumSetList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.SCPQuorumSet

  @array_type SCPQuorumSet

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(SCPQuorumSet.t())}

  defstruct [:items]

  @spec new(items :: list(SCPQuorumSet.t())) :: t()
