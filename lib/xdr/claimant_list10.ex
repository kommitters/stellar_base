defmodule StellarBase.XDR.ClaimantList10 do
  @moduledoc """
  ...
  Representation of Stellar `ClaimantList10` type.
  """
  ...
  @type t :: %__MODULE__{items: list(Claimant.t())}

  defstruct [:items]

  @spec new(items :: list(Claimant.t())) :: t()
