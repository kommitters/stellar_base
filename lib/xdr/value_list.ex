defmodule StellarBase.XDR.ValueList do
  @moduledoc """
  ...
  Representation of Stellar `ValueList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.Value

  @array_type Value

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(Value.t())}

  defstruct [:items]

  @spec new(items :: list(Value.t())) :: t()
