defmodule StellarBase.XDR.TrustLineEntryV1Ext do
  @moduledoc """
  ...
  Representation of Stellar `TrustLineEntryV1Ext` type.
  """
  ...
  @arms %{
    0 => Void,
    2 => TrustLineEntryExtensionV2
  }

  @type value ::
          Void.t()
          | TrustLineEntryExtensionV2.t()
