defmodule StellarBase.XDR.TxSetComponentList do
  @moduledoc """
  ...
  Representation of Stellar `TxSetComponentList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TxSetComponent

  @array_type TxSetComponent

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TxSetComponent.t())}

  defstruct [:items]

  @spec new(items :: list(TxSetComponent.t())) :: t()
