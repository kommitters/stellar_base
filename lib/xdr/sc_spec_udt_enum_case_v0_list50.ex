defmodule StellarBase.XDR.SCSpecUDTEnumCaseV0List50 do
  @moduledoc """
  ...
  Representation of Stellar `SCSpecUDTEnumCaseV0List50` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SCSpecUDTEnumCaseV0.t())}

  defstruct [:items]

  @spec new(items :: list(SCSpecUDTEnumCaseV0.t())) :: t()
