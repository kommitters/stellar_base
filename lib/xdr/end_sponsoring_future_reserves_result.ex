defmodule StellarBase.XDR.EndSponsoringFutureReservesResult do
  @moduledoc """
  ...
  @arms [
    END_SPONSORING_FUTURE_RESERVES_SUCCESS: Void,
    END_SPONSORING_FUTURE_RESERVES_NOT_SPONSORED: Void
  ]

  @type value ::
          Void.t()

  @type t :: %__MODULE__{value: value(), type: EndSponsoringFutureReservesResultCode.t()}
