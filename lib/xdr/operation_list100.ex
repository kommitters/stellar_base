defmodule StellarBase.XDR.OperationList100 do
  @moduledoc """
  ...
  Representation of Stellar `OperationList100` type.
  """
  ...
  @type t :: %__MODULE__{items: list(Operation.t())}

  defstruct [:items]

  @spec new(items :: list(Operation.t())) :: t()
