defmodule StellarBase.XDR.TransactionResultPairV2List do
  @moduledoc """
  ...
  Representation of Stellar `TransactionResultPairV2List` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionResultPairV2

  @array_type TransactionResultPairV2

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionResultPairV2.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionResultPairV2.t())) :: t()
