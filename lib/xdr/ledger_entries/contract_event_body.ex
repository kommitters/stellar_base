defmodule StellarBase.XDR.ContractEventBody do
  @moduledoc """
  ...
  Representation of Stellar `ContractEventBody` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.ContractEventV0

  @arms %{0 => ContractEventV0}
