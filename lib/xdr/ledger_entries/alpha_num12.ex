defmodule StellarBase.XDR.AlphaNum12 do
  ...
  @struct_spec XDR.Struct.new(asset_code: AssetCode12, issuer: AccountID)

  @type t :: %__MODULE__{asset_code: AssetCode12.t(), issuer: AccountID.t()}

  defstruct [:asset_code, :issuer]

  @spec new(asset_code :: AssetCode12.t(), issuer :: AccountID.t()) :: t()
  def new(%AssetCode12{} = asset_code, %AccountID{} = issuer),
