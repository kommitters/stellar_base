defmodule StellarBase.XDR.ContractEntryBodyType do
  @moduledoc """
  ...
  Representation of Stellar `ContractEntryBodyType` type.
  """
  ...
  def new(type \\ :DATA_ENTRY), do: %__MODULE__{identifier: type}
