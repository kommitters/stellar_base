defmodule StellarBase.XDR.PeerAddressList100 do
  @moduledoc """
  ...
  Representation of Stellar `PeerAddressList100` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.PeerAddress

  @max_length 100

  @array_type PeerAddress

  @array_spec %{type: @array_type, max_length: @max_length}

  @type t :: %__MODULE__{items: list(PeerAddress.t())}

  defstruct [:items]

  @spec new(items :: list(PeerAddress.t())) :: t()
