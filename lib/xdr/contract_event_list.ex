defmodule StellarBase.XDR.ContractEventList do
  @moduledoc """
  ...
  Representation of Stellar `ContractEventList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.ContractEvent

  @array_type ContractEvent

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(ContractEvent.t())}

  defstruct [:items]

  @spec new(items :: list(ContractEvent.t())) :: t()
