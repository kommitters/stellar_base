defmodule StellarBase.XDR.ClaimPredicateList2 do
  @moduledoc """
  ...
  Representation of Stellar `ClaimPredicateList2` type.
  """
  ...
  @type t :: %__MODULE__{items: list(ClaimPredicate.t())}

  defstruct [:items]

  @spec new(items :: list(ClaimPredicate.t())) :: t()
