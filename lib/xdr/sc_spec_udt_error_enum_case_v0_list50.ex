defmodule StellarBase.XDR.SCSpecUDTErrorEnumCaseV0List50 do
  @moduledoc """
  ...
  Representation of Stellar `SCSpecUDTErrorEnumCaseV0List50` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SCSpecUDTErrorEnumCaseV0.t())}

  defstruct [:items]

  @spec new(items :: list(SCSpecUDTErrorEnumCaseV0.t())) :: t()
