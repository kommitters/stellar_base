defmodule StellarBase.XDR.UpgradeEntryMetaList do
  @moduledoc """
  ...
  Representation of Stellar `UpgradeEntryMetaList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.UpgradeEntryMeta

  @array_type UpgradeEntryMeta

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(UpgradeEntryMeta.t())}

  defstruct [:items]

  @spec new(items :: list(UpgradeEntryMeta.t())) :: t()
