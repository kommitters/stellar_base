defmodule StellarBase.XDR.SCPHistoryEntryList do
  @moduledoc """
  ...
  Representation of Stellar `SCPHistoryEntryList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.SCPHistoryEntry

  @array_type SCPHistoryEntry

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(SCPHistoryEntry.t())}

  defstruct [:items]

  @spec new(items :: list(SCPHistoryEntry.t())) :: t()
