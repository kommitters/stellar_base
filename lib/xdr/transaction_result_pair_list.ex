defmodule StellarBase.XDR.TransactionResultPairList do
  @moduledoc """
  ...
  Representation of Stellar `TransactionResultPairList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionResultPair

  @array_type TransactionResultPair

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionResultPair.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionResultPair.t())) :: t()
