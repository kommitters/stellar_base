defmodule StellarBase.XDR.SCContractExecutable do
  ...
  @type t :: %__MODULE__{value: value(), type: SCContractExecutableType.t()}

  defstruct [:value, :type]

  @spec new(value :: value(), type :: SCContractExecutableType.t()) :: t()
  def new(value, %SCContractExecutableType{} = type), do: %__MODULE__{value: value, type: type}
