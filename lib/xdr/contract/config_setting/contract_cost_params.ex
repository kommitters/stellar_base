defmodule StellarBase.XDR.ContractCostParams do
  @moduledoc """
  ...
  Representation of Stellar `ContractCostParams` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.ContractCostParamEntry

  @max_length 1024

  @array_type ContractCostParamEntry

  @array_spec %{type: @array_type, max_length: @max_length}

  @type t :: %__MODULE__{items: list(ContractCostParamEntry.t())}

  defstruct [:items]

  @spec new(items :: list(ContractCostParamEntry.t())) :: t()
