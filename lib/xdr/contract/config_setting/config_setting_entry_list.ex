defmodule StellarBase.XDR.ConfigSettingEntryList do
  @moduledoc """
  ...
  Representation of Stellar `ConfigSettingEntryList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.ConfigSettingEntry

  @array_type ConfigSettingEntry

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(ConfigSettingEntry.t())}

  defstruct [:items]

  @spec new(items :: list(ConfigSettingEntry.t())) :: t()
