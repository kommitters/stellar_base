defmodule StellarBase.XDR.SCSpecUDTStructV0 do
  ...
  alias StellarBase.XDR.{String1024, String80, String60, SCSpecUDTStructFieldV0List}
  ...
  @type t :: %__MODULE__{doc: doc(), lib: lib(), name: name()}
  ...
  @spec new(
          ...
          lib :: String80.t(),
          name :: String60.t(),
          fields :: SCSpecUDTStructFieldV0List.t()
        ) :: t()
  def new(
        %String1024{} = doc,
        %String80{} = lib,
