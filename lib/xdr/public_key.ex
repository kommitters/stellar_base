defmodule StellarBase.XDR.PublicKey do
  ...
  @type t :: %__MODULE__{value: value(), type: PublicKeyType.t()}

  defstruct [:value, :type]

  @spec new(value :: value(), type :: PublicKeyType.t()) :: t()
  def new(value, %PublicKeyType{} = type), do: %__MODULE__{value: value, type: type}
