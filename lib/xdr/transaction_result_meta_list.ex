defmodule StellarBase.XDR.TransactionResultMetaList do
  @moduledoc """
  ...
  Representation of Stellar `TransactionResultMetaList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionResultMeta

  @array_type TransactionResultMeta

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionResultMeta.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionResultMeta.t())) :: t()
