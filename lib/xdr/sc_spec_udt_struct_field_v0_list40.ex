defmodule StellarBase.XDR.SCSpecUDTStructFieldV0List40 do
  @moduledoc """
  ...
  Representation of Stellar `SCSpecUDTStructFieldV0List40` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SCSpecUDTStructFieldV0.t())}

  defstruct [:items]

  @spec new(items :: list(SCSpecUDTStructFieldV0.t())) :: t()
