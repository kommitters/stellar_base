defmodule StellarBase.XDR.TransactionPhaseList do
  @moduledoc """
  ...
  Representation of Stellar `TransactionPhaseList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionPhase

  @array_type TransactionPhase

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionPhase.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionPhase.t())) :: t()
