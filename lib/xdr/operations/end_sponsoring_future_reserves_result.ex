defmodule StellarBase.XDR.Operations.EndSponsoringFutureReservesResult do
  ...
  @arms [END_SPONSORING_FUTURE_RESERVES_SUCCESS: Void, default: Void]

  @type t :: %__MODULE__{result: any(), code: EndSponsoringFutureReservesResultCode.t()}

  defstruct [:result, :code]

  @spec new(result :: any(), code :: EndSponsoringFutureReservesResultCode.t()) :: t()
  def new(result, %EndSponsoringFutureReservesResultCode{} = code),
  ...
  defp union_spec do
    nil
    |> EndSponsoringFutureReservesResultCode.new()
    |> XDR.Union.new(@arms)
  end
end
