defmodule StellarBase.XDR.SignerList20 do
  @moduledoc """
  ...
  Representation of Stellar `SignerList20` type.
  """
  ...
  @type t :: %__MODULE__{items: list(Signer.t())}

  defstruct [:items]

  @spec new(items :: list(Signer.t())) :: t()
