defmodule StellarBase.XDR.NodeIDList do
  @moduledoc """
  ...
  Representation of Stellar `NodeIDList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.NodeID

  @array_type NodeID

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(NodeID.t())}

  defstruct [:items]

  @spec new(items :: list(NodeID.t())) :: t()
