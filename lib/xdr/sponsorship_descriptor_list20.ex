defmodule StellarBase.XDR.SponsorshipDescriptorList20 do
  @moduledoc """
  ...
  Representation of Stellar `SponsorshipDescriptorList20` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SponsorshipDescriptor.t())}

  defstruct [:items]

  @spec new(items :: list(SponsorshipDescriptor.t())) :: t()
