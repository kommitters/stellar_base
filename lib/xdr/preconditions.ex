defmodule StellarBase.XDR.Preconditions do
  ...
  @type t :: %__MODULE__{value: value(), type: PreconditionType.t()}

  defstruct [:value, :type]

  @spec new(value :: value(), type :: PreconditionType.t()) :: t()
  def new(value, %PreconditionType{} = type), do: %__MODULE__{value: value, type: type}
