defmodule StellarBase.XDR.OperationMetaList do
  @moduledoc """
  ...
  Representation of Stellar `OperationMetaList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.OperationMeta

  @array_type OperationMeta

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(OperationMeta.t())}

  defstruct [:items]

  @spec new(items :: list(OperationMeta.t())) :: t()
