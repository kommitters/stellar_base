defmodule StellarBase.XDR.SCPEnvelopeList do
  @moduledoc """
  ...
  Representation of Stellar `SCPEnvelopeList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.SCPEnvelope

  @array_type SCPEnvelope

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(SCPEnvelope.t())}

  defstruct [:items]

  @spec new(items :: list(SCPEnvelope.t())) :: t()
