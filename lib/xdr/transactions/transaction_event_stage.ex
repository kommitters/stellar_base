defmodule StellarBase.XDR.TransactionEventStage do
  @moduledoc """
  ...
  Representation of Stellar `TransactionEventStage` type.
  """
  ...
  def new(type \\ :TRANSACTION_EVENT_STAGE_BEFORE_ALL_TXS), do: %__MODULE__{identifier: type}
