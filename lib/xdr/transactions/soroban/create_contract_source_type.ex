defmodule StellarBase.XDR.CreateContractSourceType do
  @moduledoc """
  Representation of Stellar `CreateContractSourceType` type.
  """
  ...
  def new(type \\ :CONTRACT_SOURCE_REF), do: %__MODULE__{identifier: type}
