defmodule StellarBase.XDR.SorobanAuthorizedInvocationList do
  @moduledoc """
  ...
  Representation of Stellar `SorobanAuthorizedInvocationList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.SorobanAuthorizedInvocation

  @array_type SorobanAuthorizedInvocation

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(SorobanAuthorizedInvocation.t())}

  defstruct [:items]

  @spec new(items :: list(SorobanAuthorizedInvocation.t())) :: t()
