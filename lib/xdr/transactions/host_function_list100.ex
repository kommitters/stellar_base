defmodule StellarBase.XDR.HostFunctionList100 do
  ...
  Representation of Stellar `HostFunctionList100` type.
  """
  ...
  @array_type HostFunction

  @array_spec %{type: @array_type, max_length: @max_length}

  @type t :: %__MODULE__{items: list(HostFunction.t())}

  defstruct [:items]

  @spec new(items :: list(HostFunction.t())) :: t()
