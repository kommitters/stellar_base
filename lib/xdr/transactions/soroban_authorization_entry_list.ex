defmodule StellarBase.XDR.SorobanAuthorizationEntryList do
  @moduledoc """
  ...
  Representation of Stellar `SorobanAuthorizationEntryList` type.
  """
  ...
  @array_type SorobanAuthorizationEntry

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(SorobanAuthorizationEntry.t())}

  defstruct [:items]

  @spec new(items :: list(SorobanAuthorizationEntry.t())) :: t()
