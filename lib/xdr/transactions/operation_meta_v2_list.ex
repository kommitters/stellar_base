defmodule StellarBase.XDR.OperationMetaV2List do
  @moduledoc """
  ...
  Representation of Stellar `OperationMetaV2List` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.OperationMetaV2

  @array_type OperationMetaV2

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(OperationMetaV2.t())}

  defstruct [:items]

  @spec new(items :: list(OperationMetaV2.t())) :: t()
