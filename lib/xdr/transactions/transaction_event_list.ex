defmodule StellarBase.XDR.TransactionEventList do
  @moduledoc """
  ...
  Representation of Stellar `TransactionEventList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionEvent

  @array_type TransactionEvent

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionEvent.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionEvent.t())) :: t()
