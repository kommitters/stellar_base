defmodule StellarBase.XDR.SCSpecFunctionInputV0List10 do
  @moduledoc """
  ...
  Representation of Stellar `SCSpecFunctionInputV0List10` type.
  """
  ...
  @type t :: %__MODULE__{items: list(SCSpecFunctionInputV0.t())}

  defstruct [:items]

  @spec new(items :: list(SCSpecFunctionInputV0.t())) :: t()
