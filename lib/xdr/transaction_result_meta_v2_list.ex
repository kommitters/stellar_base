defmodule StellarBase.XDR.TransactionResultMetaV2List do
  @moduledoc """
  ...
  Representation of Stellar `TransactionResultMetaV2List` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.TransactionResultMetaV2

  @array_type TransactionResultMetaV2

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(TransactionResultMetaV2.t())}

  defstruct [:items]

  @spec new(items :: list(TransactionResultMetaV2.t())) :: t()
