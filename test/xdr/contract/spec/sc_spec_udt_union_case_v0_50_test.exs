defmodule StellarBase.XDR.SCSpecUDTUnionCaseV050Test do
  use ExUnit.Case
  ...
  describe "SCSpecUDTUnionCaseV050" do
    setup do
      ...
      %{
        cases: cases,
        sponsorship_descriptor_list: SCSpecUDTUnionCaseV050.new(cases),
        binary:
    ...
    test "new/1", %{cases: cases} do
      %SCSpecUDTUnionCaseV050{cases: ^cases} = SCSpecUDTUnionCaseV050.new(cases)
    end
    ...
    test "encode_xdr/1", %{
      ...
      {:ok, ^binary} = SCSpecUDTUnionCaseV050.encode_xdr(sponsorship_descriptor_list)
    end
    ...
    test "encode_xdr!/1", %{
      ...
      ^binary = SCSpecUDTUnionCaseV050.encode_xdr!(sponsorship_descriptor_list)
    end
    ...
    test "decode_xdr/1", %{
      ...
      {:ok, {^sponsorship_descriptor_list, ""}} = SCSpecUDTUnionCaseV050.decode_xdr(binary)
    end

    test "decode_xdr/1 with an invalid binary" do
      {:error, :not_binary} = SCSpecUDTUnionCaseV050.decode_xdr(123)
    end
    ...
    test "decode_xdr!/1", %{
      ...
      {^sponsorship_descriptor_list, ""} = SCSpecUDTUnionCaseV050.decode_xdr!(binary)
    end
    ...
    test "decode_xdr!/1 with an invalid binary" do
      assert_raise XDR.VariableArrayError,
                   ...
                   fn -> SCSpecUDTUnionCaseV050.decode_xdr!(123) end
    end
  end
end
