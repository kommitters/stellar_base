defmodule StellarBase.XDR.SCSpecUDTStructFieldV040Test do
  use ExUnit.Case
  ...
  describe "SCSpecUDTStructFieldV040" do
    setup do
      ...
      %{
        fields: fields,
        sponsorship_descriptor_list: SCSpecUDTStructFieldV040.new(fields),
        binary:
    ...
    test "new/1", %{fields: fields} do
      %SCSpecUDTStructFieldV040{fields: ^fields} = SCSpecUDTStructFieldV040.new(fields)
    end
    ...
    test "encode_xdr/1", %{
      ...
      {:ok, ^binary} = SCSpecUDTStructFieldV040.encode_xdr(sponsorship_descriptor_list)
    end
    ...
    test "encode_xdr!/1", %{
      ...
      ^binary = SCSpecUDTStructFieldV040.encode_xdr!(sponsorship_descriptor_list)
    end
    ...
    test "decode_xdr/1", %{
      ...
      {:ok, {^sponsorship_descriptor_list, ""}} = SCSpecUDTStructFieldV040.decode_xdr(binary)
    end

    test "decode_xdr/1 with an invalid binary" do
      {:error, :not_binary} = SCSpecUDTStructFieldV040.decode_xdr(123)
    end
    ...
    test "decode_xdr!/1", %{
      ...
      {^sponsorship_descriptor_list, ""} = SCSpecUDTStructFieldV040.decode_xdr!(binary)
    end
    ...
    test "decode_xdr!/1 with an invalid binary" do
      assert_raise XDR.VariableArrayError,
                   ...
                   fn -> SCSpecUDTStructFieldV040.decode_xdr!(123) end
    end
  end
end
