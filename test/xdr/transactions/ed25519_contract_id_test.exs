defmodule StellarBase.XDR.HashIDPreimageEd25519ContractIDTest do
  use ExUnit.Case

  alias StellarBase.XDR.{HashIDPreimageEd25519ContractID, Hash, Uint256}
  alias StellarBase.StrKey

  describe "HashIDPreimageEd25519ContractID" do
    setup do
      ...
      %{
        ...
        ed25519: ed25519,
        salt: salt,
        ed25519_contract_id: HashIDPreimageEd25519ContractID.new(network_id, ed25519, salt),
        binary:
    ...
    test "new/1", %{
      ...
      %HashIDPreimageEd25519ContractID{
        ...
        ed25519: ^ed25519,
        salt: ^salt
      } = HashIDPreimageEd25519ContractID.new(network_id, ed25519, salt)
    end

    test "encode_xdr/1", %{ed25519_contract_id: ed25519_contract_id, binary: binary} do
      {:ok, ^binary} = HashIDPreimageEd25519ContractID.encode_xdr(ed25519_contract_id)
    end

    test "encode_xdr!/1", %{ed25519_contract_id: ed25519_contract_id, binary: binary} do
      ^binary = HashIDPreimageEd25519ContractID.encode_xdr!(ed25519_contract_id)
    end

    test "decode_xdr/2", %{ed25519_contract_id: ed25519_contract_id, binary: binary} do
      {:ok, {^ed25519_contract_id, ""}} = HashIDPreimageEd25519ContractID.decode_xdr(binary)
    end

    test "decode_xdr/2 with an invalid binary" do
      {:error, :not_binary} = HashIDPreimageEd25519ContractID.decode_xdr(123)
    end

    test "decode_xdr!/2", %{ed25519_contract_id: ed25519_contract_id, binary: binary} do
      {^ed25519_contract_id, ""} = HashIDPreimageEd25519ContractID.decode_xdr!(binary)
    end
  end
end
