defmodule StellarBase.XDR.Operations.LiquidityPoolWithdrawResultTest do
  use ExUnit.Case

  alias StellarBase.XDR.Void
  alias StellarBase.XDR.Operations.{LiquidityPoolWithdrawResult, LiquidityPoolWithdrawResultCode}
